	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item"><a href="lien_he.html" class="nav-link">Liện hệ</a></li>
...
<div class="col-md-6 d-flex align-items-center">
            <form action="#" class="subscribe-form">
              <div class="form-group d-flex">
                <input type="text" class="form-control" placeholder="Tìm kiếm địa chỉ">
    ...
    <section class="ftco-section">
    	<div class="container">
    		<div class="row justify-content-center">
    			<div class="col-md-10 mb-5 text-center">
    				<ul class="product-category">
    					...
    					<li><a href="vat_dung.html">Dịch vụ cung cấp đồ cho thú cưng</a></li>
    					<li><a href="cham_soc.html">Dịch vụ chăm sóc, khám chữa cho thú cưng</a></li>
    		...
    		<div class="row">
                ...
                <?php foreach ($dich_vu as $row) {
          ;?>
    				<div class="product">
    					<a href="dich_vu_chi_tiet.html" class="img-prod"><img style="height: 250px; width: 400px" src="<?=base_url();?>/assets/images/<?=$row->hinh_anh;?>" alt="Colorlib Template">
    						<span class="status">40%</span>
    						<div class="overlay"></div>
    					</a>
                        
    					<div class="text py-3 pb-4 px-3 text-center">
    						<h3><a href="<?=base_url();?>dich_vu_chi_tiet/<?=$row->ma_dv;?>"><?=$row->ten_dich_vu;?></a></h3>
    						<div class="d-flex">
    							<div class="pricing">
            ...
            ;?>
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="dich_vu_chi_tiet.html" class="img-prod"><img class="img-fluid" src="images/vong_co.jpg " alt="Colorlib Template" style="width: 400px; height: 250px"">
    						<div class="overlay"></div>
    					</a>
    					<div class="text py-3 pb-4 px-3 text-center">
    						<h3><a href="#">Vòng cổ da</a></h3>
    						<span class="btn btn-primary">Pet Hotel</span>
    						<br><span>Số 28 Xã Đàn, <br>Hà Nội</span>
    						<div class="d-flex">
    							<div class="pricing">
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="dich_vu_chi_tiet.html" class="img-prod"><img class="img-fluid" src="images/sua_tam.jpg" alt="Colorlib Template" style="width: 400px; height: 250px">
	    					<div class="overlay"></div>
	    				</a>
    					<div class="text py-3 pb-4 px-3 text-center">
    						<h3><a href="#">Sữa tắm</a></h3>
    						<span class="btn btn-primary">Bệnh viện Dreampet</span>
    						<br><span> Số 28 Trần Khát Trân,<br> Hà Nội</span>
    						<div class="d-flex">
    							<div class="pricing">
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="dich_vu_chi_tiet.html" class="img-prod"><img class="img-fluid" src="images/nhuom.jpg" alt="Colorlib Template" style="width: 400px; height: 250px">
    						<div class="overlay"></div>
    					</a>
    					<div class="text py-3 pb-4 px-3 text-center">
    						<h3><a href="#">Nhuộm lông</a></h3>
    						<span class="btn btn-primary">Chan Chan Pet</span>
    						<br><span> Số 28 Cầu Giấy,<br> Hà Nội</span>
    						<div class="d-flex">
    							<div class="pricing">
		    						<p class="price"><span class="mr-2 price-dc">400.000đ</span><span class="price-sale">240.000đ</span></p>
		    					</div>
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="dich_vu_chi_tiet.html" class="img-prod"><img class="img-fluid" src="images/viem_ruot.jpg" alt="Colorlib Template" style="width: 400px; height: 250px">
    						<span class="status">30%</span>
    						<div class="overlay"></div>
    					</a>
    					<div class="text py-3 pb-4 px-3 text-center">
    						<h3><a href="#">Điều trị viêm ruột</a></h3>
    						<span class="btn btn-primary">Happy Dog</span>
    						<br><span> Số 28 Trần Khát Trân, <br>Hai Bà Trưng,Hà Nội</span>
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="dich_vu_chi_tiet.html" class="img-prod"><img class="img-fluid" src="images/thuc_an_kho.jpg" alt="Colorlib Template" style="width: 400px; height: 250px">
    						<div class="overlay"></div>
    					</a>
    					<div class="text py-3 pb-4 px-3 text-center">
    						<h3><a href="#">Thức ăn khô cho cún</a></h3>
    						<span class="btn btn-primary"> Pet xinh</span>
    						<br><span> Số 28 Xã Đàn,<br> Hà Nội</span>
    						<div class="d-flex">
    							<div class="pricing">
		    						<p class="price"><span class="mr-2 price-dc">240.000đ</span>
		    							<span class="price-sale">220.000đ</span></p>
		    					</div>
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="dich_vu_chi_tiet.html" class="img-prod"><img class="img-fluid" src="images/pate.jpg" alt="Colorlib Template" style="width: 400px; height: 250px">
	    					<div class="overlay"></div>
	    				</a>
    					<div class="text py-3 pb-4 px-3 text-center">
    						<h3><a href="#">Pate cho mèo</h3>
    						<span class="btn btn-primary">Chan Chan Pet</span>
    						<br><span> Số 28 Cầu Giấy,br> Hà Nội</span>

    						<div class="d-flex">
    							<p class="price"><span>240.000đ</span></p>
	    					</div>
