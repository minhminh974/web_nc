...
<head>
    ...
    <title>Đăng nhập hệ thống | K19HTTTA</title>
                        ...
                        <div class="mx-auto app-login-box col-sm-12 col-md-10 col-lg-9">
                            ...
                            <div>
                                <form class="">
                                    <div class="form-row">
                                        <div class="col-md-6">
                                            <div class="position-relative form-group"><label for="exampleEmail" class="">Email</label><input name="email" id="exampleEmail" placeholder="Nhập địa chỉ Email..." type="email" class="form-control"></div>
                                        </div>
                                        <div class="col-md-6">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="ml-auto"><a href="javascript:void(0);" class="btn-lg btn btn-link">Quên mật khẩu</a>
