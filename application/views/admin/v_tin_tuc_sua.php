                            ...
                            <div class="main-card mb-12 card">
                                <div class="card-body"><h5 class="card-title">SỬA TIN TỨC</h5>
                                    ...
                                    <form method="POST" action="<?=base_url().'admin/quan_tri_tin_tuc/thuc_hien_sua_tin_tuc';?>">
                                        ...
                                        <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-4 col-form-label">Người tạo</label>
                                            <div class="col-sm-8">
                                                <input name="txtNguoiTao" class="form-control" value="<?=$tin_tuc->nguoi_tao;?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="position-relative row form-check">
                                            <div class="col-sm-10 offset-sm-2">
                                                ...
                                                <input name="txtID" type="hidden" value="<?=$tin_tuc->ma_tin_tuc;?>">
                                            </div>
                                        </div>
                                    </form>
                                    </div>
