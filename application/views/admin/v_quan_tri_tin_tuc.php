...
<head>
    ...
    <title>Quản trị tin tức | BOOKCAREPET</title>
                    ...
                    <div class="card mb-3">
                        <div class="card-header pr-0 pl-0">
                            <div class="row no-gutters align-items-center w-100">
                                <div class="col font-weight-bold pl-3">Nam</div>
                                <div class="d-none d-md-block col-6 text-muted">
                                    <div class="row no-gutters align-items-center">
                                       
                                        
                                        <div class="col-9">Năm sinh</div>
                                ...
                                <div class="d-none d-md-block col-6">        
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="media col-6 align-items-center">
                                            <img style="width: 40px; height: auto;" src="<?=base_url();?>/assets/images/<?=$row1->anh;?>" alt="" class="d-block ui-w-30 rounded-circle">
                                            <div class="media-body flex-truncate ml-2">
                                                <a href="javascript:void(0)" class="d-block text-truncate"><?=$row1->nguoi_tao;?></a>
                                                <div class="text-muted small text-truncate"><?=$row1->thoi_gian;?></div>
                                            </div>
                                        </div>
                                        <div class="col-3">
                                            <a href="<?=base_url();?>admin/quan_tri_tin_tuc/sua/<?=$row1->ma_tin_tuc;?>">
                                            <button class="ladda-button mb-2 mr-2 btn btn-danger" data-style="expand-right">
                                            ...
                                            <a href="<?=base_url();?>admin/quan_tri_tin_tuc/xoa/<?=$row1->ma_tin_tuc;?>">
                                            <button class="ladda-button mb-2 mr-2 btn btn-danger" data-style="expand-right">
                            ...
                            <div class="row no-gutters align-items-center">
                                ...
                                <div class="d-none d-md-block col-6">        
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="media col-6 align-items-center">
                                            <img style="width: 40px; height: auto;" src="../assets/images/<?=$row2->anh;?>" alt="" class="d-block ui-w-30 rounded-circle">
                                            <div class="media-body flex-truncate ml-2">
                                                <a href="javascript:void(0)" class="d-block text-truncate"><?=$row2->nguoi_tao;?></a>
                                                <div class="text-muted small text-truncate"><?=$row2->thoi_gian;?></div>
                                            </div>
                                        </div>
                                    </div>    
                                </div>
