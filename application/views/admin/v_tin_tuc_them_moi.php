...
<head>
    ...
    <title>Thêm mới tin tức | BOOKCAREPET</title>
                            ...
                            <div class="main-card mb-3 card">
                                <div class="card-body"><h5 class="card-title">THÊM MỚI TIN TỨC</h5>
                                    ...
                                    <form method="POST" action="<?=base_url().'admin/quan_tri_tin_tuc/thuc_hien_them_moi_tin_tuc';?>">
                                        ...
                                        <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-4 col-form-label">Ảnh minh họa</label>
                                            <div class="col-sm-8">
                                                <input type="file" name="txtAnh class="form-control">
                                            </div>
                                        </div>
                                        <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-2 col-form-label">Người tạo</label>
                                            <div class="col-sm-10"><input name="txtNguoiTao" class="form-control"></div>
                                        </div>
